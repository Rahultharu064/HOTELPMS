...
exports.ensureGallerySchema = ensureGallerySchema;
...
async function ensureGallerySchema() {
    ...
    `);
        const count = await database_1.prisma.galleryVenue.count();
        if (count === 0) {
            await database_1.prisma.galleryVenue.createMany({
...
//# sourceMappingURL=ensureGallerySchema.js.map