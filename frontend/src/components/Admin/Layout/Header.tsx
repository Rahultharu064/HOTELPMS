...
import { Bell, Search, ChevronDown, Settings, LogOut, User, MessageSquare, Zap, ShieldCheck } from "lucide-react";
import { MobileMenuButton } from "./Sidebar";

const notifications = [
  { id: 1, text: "System Security Alert: New Login from Unknown IP", time: "2 min ago", type: "security", unread: true },
  { id: 2, text: "Database Backup Completed Successfully", time: "15 min ago", type: "system", unread: true },
  { id: 3, text: "License Renewal Reminder: 30 days remaining", time: "1 hr ago", type: "license", unread: false },
  { id: 4, text: "New Support Ticket: Property Config Issue", time: "2 hrs ago", type: "support", unread: false },
];
          ...
          {notifOpen && (
            <div className="absolute right-0 mt-4 w-[380px] bg-white rounded-[32px] shadow-2xl border border-gray-100 overflow-hidden animate-fade-down z-[60]">
              <div className="p-6 border-b border-gray-50 flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-black uppercase tracking-[0.2em] text-[#111827]">Security & System</h3>
                ...
                {notifications.map((n) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${n.unread ? "bg-red-50 text-red-600" : "bg-gray-100 text-gray-400"
                      ...
                      {n.type === 'security' ? <ShieldCheck size={16} /> : <Zap size={16} />}
                    </div>
                    <div>
            ...
            <div className="absolute right-0 mt-4 w-64 bg-white rounded-[32px] shadow-2xl border border-gray-100 overflow-hidden animate-fade-down z-[60]">
              ...
              <div className="p-2">
                {[
                  ...
                  { label: "Security Config", icon: Settings },
                ].map((item) => (
                  <button
                    key={item.label}
