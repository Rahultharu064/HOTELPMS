  ...
  return (
    <div className="space-y-10 animate-fade-in pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
        <div>
          <h1 className="text-3xl font-black text-[#111827] tracking-tight">Staff & Assignments</h1>
          <p className="text-gray-400 text-[11px] font-bold uppercase tracking-widest mt-2">Manage floor personnel and cleaning duty allocations</p>
        </div>
        <div className="flex items-center gap-3">
          <button 
            onClick={() => setIsAddModalOpen(true)}
            className="px-6 py-4 bg-[#111827] text-white rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-[#14532D] transition-all flex items-center gap-2 shadow-lg shadow-black/10"
          >
                ...
                >
                  <div className="flex items-start justify-between mb-8">
                     ...
                     <div className={`px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest ${
                       s.status === 'on_duty' ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-600'
                     }`}>
                        {s.status.replace('_', ' ')}
                     </div>
                  </div>
